   ...
   <Wrapper>
     ...
     <InputContainer>
      ...
      <FromToIcons>
       ...
       <InputBoxes>
         <Input placeholder="Lieu de prise en charge" value={pickup} onChange={ e => setPickup(e.target.value)} />
         <Input placeholder="Où aller vous ?" value={dropoff} onChange={ e => setDropoff(e.target.value)} />
       </InputBoxes>
